...
<ResumeBlock>
    ...
    <div class="blockSection">
        ...
        ### Network Engineering
        - Experience operating large-scale networks in data center and edge in running both traditional routing protocols (BGP, IS-IS) and home-grown ([OpenR](https://github.com/facebook/openr)).
...
<ResumeBlock>
    ...
    <div class="blockSection">
        ...
        - Built tooling to parse verbose FBOSS switch ASIC state logs, extracting ms-granular data on resource usage, convergence timing, and identify routing micro-loops speeding up the time to triage hard to root cause incidents, aiding in qualifications, and help show bottlenecks across our current network design to shape future roadmaps.
