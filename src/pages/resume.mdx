...
<ResumeBlock>
    ...
    <div class="blockSection">
        ...
        In my spare time, I'm passionate about paragliding, web development, remote control aircraft, and embedded systems. I contribute to open-source projects including [Leaf](https://www.leafvario.com/), a variometer for paragliding, and an [IoT chessboard](https://github.com/scottyob/esp-chess), combining my interests in hardware and software.
    </div>
